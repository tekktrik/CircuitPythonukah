...
![Build CI Status](https://img.shields.io/github/workflow/status/tekktrik/CircuitPythonukiah_HW/Build%20CI/main)
...
* Licensed under the Certification Mark License Agreement by the OSHWA:
